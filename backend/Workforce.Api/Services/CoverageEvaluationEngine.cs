...
public sealed class CoverageEvaluationEngine
{
    ...
    {
        _db.CoverageAuditEntries.Add(new CoverageAuditEntry { ShiftId = shiftId, EvaluatedAt = DateTime.UtcNow, Status = result.Status.ToString(), DetailsJson = System.Text.Json.JsonSerializer.Serialize(result), TriggeredBy = triggeredBy });
