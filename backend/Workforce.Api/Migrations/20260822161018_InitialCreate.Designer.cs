...
namespace Workforce.Api.Migrations
{
    ...
    [Migration("20260822161018_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workforce.Api.Models.Employee", b =>
                {
                    ...
                    b.Property<decimal>("PositionPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("Workforce.Api.Models.EmployeeCompetence", b =>
                {
                    ...
                    b.HasKey("EmployeeId", "CompetenceId");
            ...
            modelBuilder.Entity("Workforce.Api.Models.Absence", b =>
                {
                    b.HasOne("Workforce.Api.Models.Employee", "Employee")
                        .WithMany("Absences")
            ...
            modelBuilder.Entity("Workforce.Api.Models.EmployeeCompetence", b =>
                {
                    b.HasOne("Workforce.Api.Models.Competence", "Competence")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Workforce.Api.Models.ShiftAssignment", b =>
                {
                    ...
                    b.HasOne("Workforce.Api.Models.Shift", "Shift")
