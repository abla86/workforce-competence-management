...
export const api = {
  ...
  coverageHistory: (shiftId, take = 20) => request(`/api/shifts/${shiftId}/coverage/history?take=${take}`),
  coverageScenario: (shiftId, employeeIds) => request(`/api/shifts/${shiftId}/coverage/scenario`, { method: "POST", body: JSON.stringify({ removeEmployeeIds: employeeIds }) }),
